...
<script type="text/x-red" data-template-name="watson-conversation-ucg">
...
<script type="text/x-red" data-help-name="watson-conversation-ucg">
...
<script type="text/javascript">
    ...
    (function() {
        RED.nodes.registerType('watson-conversation-ucg', {
            category: 'IBM Watson',
            defaults: {
              name: {value: ''},
              workspaceid: {value: ''},
            ...
            paletteLabel: 'conversation UCG',
            label: function() {
                return this.name || 'conversation UCG';
            },
            labelStyle: function() {
