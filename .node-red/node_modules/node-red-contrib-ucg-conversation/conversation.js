...
module.exports = function(RED) {
  ...
  var pkg = require('/usr/src/node-red/node_modules/node-red-contrib-ucg-conversation/package.json'),
    ConversationV1 = require('watson-developer-cloud/conversation/v1'),
    serviceutils = require('/usr/src/node-red/node_modules/node-red-contrib-ucg-conversation/service-utils.js'),
    service = null,
    sUsername = null,
    sPassword = null;
  ...
  RED.nodes.registerType('watson-conversation-ucg', WatsonConversationV1Node, {
    credentials: {
      username: {
        type: 'text'
      },
